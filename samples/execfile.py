...
file_path_small = './data_selected_file_path_small.txt'
...
# 小数据特征选择
# moveFileto(file_path_small,  target_file_path)
# moveFileto(file_path_big,  target_file_path)
